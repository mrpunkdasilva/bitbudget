...
export const TableArea = ({ list, onDeleteItem }: Props) => {
    ...
    return (
        <table className="table">
            <thead>
                <tr>
                    <th className="table__head-column" style={{ width: 100 }}>Data</th>
                    <th className="table__head-column" style={{ width: 130 }}>Categoria</th>
                    <th className="table__head-column">Título</th>
                    <th className="table__head-column" style={{ width: 150 }}>Valor</th>
                    <th className="table__head-column" style={{ width: 100 }}>Ações</th>
                </tr>
            </thead>
            <tbody>
                {list.length > 0 ? (
