...
export const InputArea = ({ onAdd }: Props) => {
  ...
  const handleAddEvent = () => {
    ...
    if (!isDateValid || !isCategoryValid || !isTitleValid || !isValueValid) {
      const errors = [dateError, categoryError, titleError, valueError].filter(err => err !== '');
  ...
  return (
    <div className="input-area">
      <label className="input-area__label">
        ...
        />
        {dateError && (
          <div id="date-error" className="input-area__error">
            {dateError}
          </div>
        )}
      </label>
      <label className="input-area__label">
        ...
        {categoryError && (
          <div id="category-error" className="input-area__error">
            {categoryError}
          </div>
        )}
      </label>
      <label className="input-area__label">
        ...
        />
        {titleError && (
          <div id="title-error" className="input-area__error">
            {titleError}
          </div>
        )}
      </label>
      <label className="input-area__label">
        ...
        />
        {valueError && (
          <div id="value-error" className="input-area__error">
            {valueError}
          </div>
        )}
      </label>
